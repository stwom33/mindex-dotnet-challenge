...
namespace CodeChallenge.Repositories
{
    public class EmployeeRespository : IEmployeeRepository
    {
        ...
        {
            return _employeeContext.Employees.Include(emp => emp.DirectReports).SingleOrDefault(e => e.EmployeeId == id);
        }
        ...
        public Compensation AddCompensation(Compensation comp)
        {
